...
class StrategyGamesScreen extends StatelessWidget {
  const StrategyGamesScreen({super.key});
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  _buildGameCard(
                    context,
                    title: 'Mini Satranç',
                    description: 'Basitleştirilmiş satranç varyantı',
                    icon: Icons.grid_on,
                    color: Colors.brown,
                    onTap: () {
                      ...
                      if (adService.isInterstitialAdReady.value) {
                        adService.showInterstitialAd().then((_) {
                          ...
                          Get.toNamed(AppRoutes.miniChess);
                        });
                      } else {
                  ...
                  _buildGameCard(
                    ...
                    onTap: () {
                      ...
                      if (adService.isInterstitialAdReady.value) {
                        adService.showInterstitialAd().then((_) {
                          // Reklam tamamlandıktan sonra oyun sayfasına git
                          Get.toNamed(AppRoutes.ticTacToe);
                        });
                      } else {
                        // Reklam yoksa direkt oyunu aç
                        Get.toNamed(AppRoutes.ticTacToe);
                  ...
                  _buildGameCard(
                    context,
                    title: 'Connect Four',
                    description: 'Dört taş birleştirme',
                    icon: Icons.circle,
                    color: Colors.blue,
                    onTap: () {
                      // Önce bir interstitial reklam göster, sonra oyunu aç
                      if (adService.isInterstitialAdReady.value) {
                        adService.showInterstitialAd().then((_) {
                          // Reklam tamamlandıktan sonra oyun sayfasına git
                          Get.toNamed(AppRoutes.connectFour);
                        });
                      } else {
                        // Reklam yoksa direkt oyunu aç
                        Get.toNamed(AppRoutes.connectFour);
